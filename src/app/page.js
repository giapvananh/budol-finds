...
export default async function Home() {
  ...
  return (
    <main className="min-h-screen bg-[#f6f7fb] text-black">
        ...
        <div className="overflow-hidden rounded-[36px] bg-[#f5ede1] p-4 shadow-xl">
          ...
          <div className="relative overflow-hidden rounded-[30px] bg-gradient-to-br from-[#30261f] via-[#5b4737] to-[#1f1b18] p-6 text-white">
            ...
            <div className="relative z-10">
              ...
              <h2 className="mt-5 text-[48px] font-black leading-[0.9]">
                SMART FINDS
              </h2>

              <h3 className="text-[48px] font-black leading-[0.9] text-orange-400">
                BETTER LIVING
              </h3>

              <p className="mt-5 max-w-md text-base font-semibold text-white/90">
            ...
            <div className="absolute right-3 top-3 flex h-28 w-28 flex-col items-center justify-center rounded-full bg-orange-500 text-center font-black shadow-2xl">
      ...
      <section
        id="products"
        className="mx-auto max-w-7xl px-3 py-4"
      >
        ...
        <div className="grid grid-cols-2 gap-4">
          ...
          {products.map((item, index) => {
            ...
            const badge = pick(item, ["badge"]) || "HOT";
